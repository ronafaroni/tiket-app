...
Route::get('/booking/{booking:slug}', [BookingController::class, 'booking'])->name('front.booking');
Route::post('/booking/{booking:slug}', [BookingController::class, 'bookingStore'])->name('front.booking_store');

Route::get('/booking/finished/{bookingTransaction}', [FrontController::class, 'bookingFinished'])->name('front.Booking_finished');
